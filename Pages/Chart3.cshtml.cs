...
{
    public class Chart3Model : DI_BasePageModel
    {
        public string url;
        ...
        public async Task OnGetAsync()
        {
            ...
            url = Constants.EmbedUrl + programmaticFilter.EmbedId3;
            ...
            embedToken = await domoHttpClient.GetEmbedToken(accessToken, programmaticFilter.EmbedId3, programmaticFilter.Filter);
        }
    }
}
