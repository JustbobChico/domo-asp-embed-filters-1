...
{
    public class Chart4Model : DI_BasePageModel
    {
        public string url;
        ...
        public async Task OnGetAsync()
        {
            ...
            url = Constants.EmbedUrl + programmaticFilter.EmbedId4;
            ...
            embedToken = await domoHttpClient.GetEmbedToken(accessToken, programmaticFilter.EmbedId4, programmaticFilter.Filter);
        }
    }
}
